...
function OurMission() {
  return (
    <section className="bg-unit-black-100 text-unit-grey-10 px-8 md:px-16 xl:px-56 2xl:px-128 flex flex-col">
      <div className="flex md:hidden items-start md:items-center gap-x-8 sm:gap-x-12 md:gap-x-24 xl:gap-x-32 relative">
        <div className="w-[1px] bg-unit-grey-30 h-32" />
      </div>
      <div className="flex items-start md:items-center gap-x-8 sm:gap-x-12 md:gap-x-24 xl:gap-x-32 relative">
        <div className="w-[1px] bg-unit-grey-30 h-96" />
        <div className="absolute size-3 border border-unit-grey-10 bg-unit-black-100 rounded-full -left-1.5 top-4 md:top-20" />
        <motion.div
        ...
        >
          <h2 className="text-3xl md:text-5xl font-semibold">
            Our{" "}
            <span className="bg-gradient-to-r from-unit-purple-40 via-unit-purple-20 to-unit-blue-40 from-0% via-90% inline-block text-transparent bg-clip-text h-12 md:h-14">
              Mission.
            </span>
          </h2>
      ...
      <div className="flex items-start md:items-center gap-x-8 sm:gap-x-12 md:gap-x-24 xl:gap-x-32 relative">
        <div className="w-0.5 bg-unit-grey-30 h-48 md:h-96" />
        <div className="absolute size-3 border border-unit-grey-10 bg-unit-black-100 rounded-full -left-1.5 top-4 md:top-20" />
        <motion.div
          className="flex flex-col gap-y-3 relative"
          initial={{ opacity: 0, x: -10 }}
      ...
      <div className="flex items-start md:items-center gap-x-8 sm:gap-x-12 md:gap-x-24 xl:gap-x-32 relative pr-8">
        <div className="border-l border-b rounded-bl-2xl border-unit-grey-30 w-1/2 h-48" />
      </div>
      <div className="flex items-start md:items-center gap-x-8 sm:gap-x-12 md:gap-x-24 xl:gap-x-32 relative px-4">
